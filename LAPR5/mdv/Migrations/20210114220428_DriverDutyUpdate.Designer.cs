...
namespace mdv.Migrations
{
    ...
    [Migration("20210114220428_DriverDutyUpdate")]
    partial class DriverDutyUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mdv.Domain.DriverDutys.DriverDuty", b =>
                {
            ...
            modelBuilder.Entity("mdv.Domain.DriverDutys.DriverDuty", b =>
                {
                    b.OwnsOne("mdv.Domain.DriverDutys.DriverDutyCode", "driverDutyCode", b1 =>
                        {
                            b1.Property<string>("DriverDutyId")
                                .HasColumnType("nvarchar(450)");

                            b1.Property<string>("driverDutyCode")
            ...
            modelBuilder.Entity("mdv.Domain.WorkBlocks.WorkBlock", b =>
                {
                    b.HasOne("mdv.Domain.DriverDutys.DriverDuty", null)
                        .WithMany("listWorkBlocks")
                        .HasForeignKey("DriverDutyId");
