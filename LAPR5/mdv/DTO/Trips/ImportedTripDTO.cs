...
namespace mdv.DTO.Trips {
    public class ImportedTripDTO {
        ...
        public ImportedTripDTO (string key, Guid Id, LineId lineID, PathId pathID, string tripDepartureTime, List<NodePassageDTO> nodePassageListDTO) {
            this.key = key;
            this.Id = Id;
            this.lineID = lineID;
            this.pathID = pathID;
        ...
        public override bool Equals (Object obj) {
            if ((obj == null) || !this.GetType ().Equals (obj.GetType ())) {
                ...
                ImportedTripDTO dto = (ImportedTripDTO) obj;
