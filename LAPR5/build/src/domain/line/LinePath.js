...
class LinePath extends Entity_1.Entity {
    ...
    static create(LineDTO) {
        ...
        var newPathOrFailure = Path_1.Path.create(LineDTO.path);
        if (newPathOrFailure.isFailure) {
            return Result_1.Result.fail(newPathOrFailure.error);
        }
        ...
        return Result_1.Result.ok(new LinePath({
            path: newPathOrFailure.getValue(),
