...
exports.DriverTypeCode = void 0;
const ValueObject_1 = require("../../core/domain/ValueObject");
const Result_1 = require("../../core/logic/Result");
const Guard_1 = require("../../core/logic/Guard");
class DriverTypeCode extends ValueObject_1.ValueObject {
    constructor(props) {
        super(props);
    }
    get value() {
    ...
    static create(code) {
        ...
        return Result_1.Result.ok(new DriverTypeCode({ value: code }));
    }
}
exports.DriverTypeCode = DriverTypeCode;
//# sourceMappingURL=DriverTypeCode.js.map